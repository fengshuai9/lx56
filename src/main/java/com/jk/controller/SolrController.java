...
public class SolrController {
    ...
    public Map<String,Object> userlist(UserSolr users, Integer page, Integer rows) throws IOException, SolrServerException {
        //因为使用easyui返回数据
        Map<String,Object> mSolr=new HashMap<String,Object>();
        //把所有查询的高亮显示内容发到list中
        List<UserSolr> userslist=new ArrayList<>();
        //查询条件的对象
